  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Adicionar Tutor</h1>
          <p className="text-muted-foreground">Preencha os dados para cadastrar um novo responsável.</p>
        </div>
        <Link to="/clients">
      ...
      <Tabs defaultValue="general" className="w-full">
        <TabsList className="grid w-full grid-cols-3 bg-secondary text-secondary-foreground rounded-lg p-1 mb-4">
          <TabsTrigger value="general" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm rounded-md">Geral</TabsTrigger>
          <TabsTrigger value="address" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm rounded-md">Endereço</TabsTrigger>
          <TabsTrigger value="extras" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm rounded-md">Extras</TabsTrigger>
        </TabsList>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <Input placeholder="Número/Email" className="flex-1" />
