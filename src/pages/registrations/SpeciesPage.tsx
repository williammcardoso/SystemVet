          ...
          <div className="flex items-center gap-4">
            <div>
              <h1 className="text-2xl font-semibold flex items-center gap-3 text-[#1E293B] dark:text-gray-100 group">
                <FaPaw className="h-5 w-5 text-gray-500 dark:text-gray-400" /> Cadastro de Espécies
              </h1>
        ...
        <Card className="bg-white/90 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.05)] hover:shadow-[0_4px_8px_rgba(0,0,0,0.08)] transition-all duration-300 border-t-4 border-green-400 dark:bg-gray-800/90">
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            <CardTitle className="flex items-center gap-2 text-lg font-semibold text-[#374151] dark:text-gray-100">
              <FaPaw className="h-5 w-5 text-green-500" /> Lista de Espécies
            </CardTitle>
            <div className="flex gap-2">
              ...
              />
              <Button onClick={handleAddSpecies} className="rounded-md bg-gradient-to-r from-blue-500 to-indigo-500 text-white hover:from-blue-600 hover:to-indigo-600 font-semibold transition-all duration-200 shadow-md hover:shadow-lg">
                  ...
                  {speciesList.map((species, index) => (
                    <TableRow key={species.id} className={cn(index % 2 === 1 && "bg-muted/50")}>
                      ...
                      <TableCell className="text-right">
                        ...
                        <Button variant="ghost" size="sm" onClick={() => handleDeleteSpecies(species.id)} className="rounded-md hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-700 dark:hover:text-gray-200 transition-colors duration-200">
