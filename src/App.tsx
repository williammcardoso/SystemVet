...
import AddPrescriptionPage from "./pages/AddPrescriptionPage"; // Nova importação
      ...
      <BrowserRouter>
        <Layout>
          <Routes>
            ...
            <Route path="/clients/:clientId/animals/:animalId/add-prescription" element={<AddPrescriptionPage />} /> {/* Nova rota */}
