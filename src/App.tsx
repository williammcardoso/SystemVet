...
import ClientsPage from "./pages/ClientsPage"; // Agora Tutores
import AddClientPage from "./pages/AddClientPage";
import AddAnimalPage from "./pages/AddAnimalPage"; // Agora para Pacientes
import ClientDetailPage from "./pages/ClientDetailPage"; // Detalhes do Tutor
  ...
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Layout>
          <Routes>
            <Route path="/" element={<Dashboard />} /> {/* Rota padrão para Dashboard */}
            <Route path="/dashboard" element={<Dashboard />} />
            <Route path="/quick-search" element={<QuickSearchPage />} /> {/* Nova rota */}

            <Route path="/clients" element={<ClientsPage />} /> {/* Tutores */}
            <Route path="/clients/add" element={<AddClientPage />} />
            <Route path="/clients/:clientId" element={<ClientDetailPage />} /> {/* Detalhes do Tutor */}

            <Route path="/patients" element={<PatientsPage />} /> {/* Nova rota para Pacientes */}
            <Route path="/animals/add" element={<AddAnimalPage />} /> {/* Adicionar Paciente */}
