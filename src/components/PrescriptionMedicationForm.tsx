...
const PrescriptionMedicationForm: React.FC<PrescriptionMedicationFormProps> = ({
  ...
  const [autoGeneratedInstructions, setAutoGeneratedInstructions] = useState<string>(""); // Stores only the auto-generated text
  ...
  useEffect(() => {
    // Generate instructions automatically if not using custom
    let instructions = "";
    ...
    setAutoGeneratedInstructions(instructions);
  ...
  const handleSave = () => {
    ...
    const updatedMedication: MedicationData = {
      ...
      generatedInstructions: useCustomInstructions ? customInstructionInput.trim() : autoGeneratedInstructions,
